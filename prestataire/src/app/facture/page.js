...
import { Search, Phone, MapPin, CheckCircle, FileText as FileIcon, ClipboardList, Activity, CheckSquare, File, FileText as DocumentIcon } from "lucide-react";
      ...
      <div className="w-full max-w-7xl bg-white p-6 rounded-xl shadow-md">
        ...
        <div className="overflow-x-auto mt-6">
          <table className="min-w-full bg-white text-black">
            <thead>
              <tr>
                <th className="px-4 py-2 border-b text-center">Numero</th>
                <th className="px-4 py-2 border-b text-center">Client</th>
            ...
            <tbody>
              {interventions.map((item, index) => (
                <tr key={index} className="hover:bg-gray-100">
                  ...
                  <td className="px-4 py-2 border-b text-center">{item.client}</td>
                  <td className="px-4 py-2 border-b text-center">
                    <span className={`px-2 py-1 rounded-full text-white ${item.status === "verser" ? "bg-green-300" : "bg-red-300"}`}>
                      {item.status}
                    </span>
                  </td>
