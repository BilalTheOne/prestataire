export default function InvoicePage() {
    return (
      <div className="flex flex-col items-center bg-gray-50 min-h-screen p-10">
        <div className="w-full max-w-[210mm] bg-white shadow-md rounded-lg border border-gray-300 p-5">
          <div className="flex justify-between items-center mb-5">
            <img
              src="https://servicepro.canbridgeapp.com/assets/logo-vertigo.b6dd3a74.svg"
              alt="ServicePro Logo"
              className="h-16"
            />
          ...
          <div className="text-right">
            <p className="text-gray-800">Bénéfice: 6000.00 €</p>
            <p className="text-gray-800">Commission: 20%</p>
            <h3 className="font-bold text-xl text-gray-800">Prix total: 2000 €</h3>
          </div>
